      ...
      ({ lib, options, ... }: {
        config = {
          ...
          programs.jov = {
            ...
            instances.default = {};
            bundledPlugins = lib.mapAttrs (name: _: { enable = enableFirstParty name; }) options.programs.jov.bundledPlugins;
          };
        };
      })
    ];
...
stdenv.mkDerivation (finalAttrs: {
  ...
  env = {
    ...
    CONFIG_OPTIONS_GOLDEN = "${../generated/jov-config-options.nix}";
