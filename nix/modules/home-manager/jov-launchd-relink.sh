...
link_agent "$HOME/Library/LaunchAgents/com.steipete.jov.gateway.nix.plist" \
  "com.steipete.jov.gateway.nix"

link_agent "$HOME/Library/LaunchAgents/com.steipete.jov.gateway.nix-test.plist" \
  "com.steipete.jov.gateway.nix-test"

link_agent "$HOME/Library/LaunchAgents/com.steipete.jov.gateway.prod.plist" \
  "com.steipete.jov.gateway.prod"

link_agent "$HOME/Library/LaunchAgents/com.steipete.jov.gateway.test.plist" \
  "com.steipete.jov.gateway.test"
